...
The further reading isn't required in order to attempt the tasks. You can pick (or mix and match) according to your appetite and time!

- [Further reading](./OPTIONAL_going-further-reading.md)
- [Further tasks](./OPTIONAL_going-further-tasks.md)